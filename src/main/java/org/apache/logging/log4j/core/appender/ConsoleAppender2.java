...
public final class ConsoleAppender2 extends AbstractOutputStreamAppender {
    ...
    private ConsoleAppender2(final String name, final Layout<? extends Serializable> layout, final Filter filter,
     ...
     */
    @PluginFactory
    public static ConsoleAppender2 createAppender(
        ...
        return new ConsoleAppender2(name, layout, filter, getManager(isFollow, target, layout), ignoreExceptions);
    }
